...
{
    my $programming_category = models('Schema::Category')->create({
        name => 'Programming',
    });
    ...
    isa_ok models('Schema::Category')->get_with_jobs, 'Jobeet::Schema::ResultSet::Category',
      'get_with_jobs: returning "Jobeet::Schema::ResultSet::Category" object';
    ...
    $programming_job->update({ expires_at => $yesterday }); # expired
    is models('Schema::Category')->get_with_jobs->count, 0,
      'get_with_jobs: expired job is not appeared';
}
